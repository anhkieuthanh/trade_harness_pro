...
- [ ] **Phase 1: Core Async Engine & Connection** - Thiết lập WebSocket kết nối Binance, cache Portfolio State trong RAM, kết nối async tới LM Studio.
...
Plans:
- [ ] 01-01: Khởi tạo cấu trúc source code, cấu hình môi trường và kết nối WebSocket Binance
- [ ] 01-02: Xây dựng cấu trúc in-memory Portfolio State cache và bộ lọc dữ liệu
- [ ] 01-03: Hiện thực hóa client kết nối async tới LM Studio và template Prompt Context Harness
...
|-------|----------------|--------|-----------|
| 1. Core Async Engine & Connection | 0/3 | Not started | - |
